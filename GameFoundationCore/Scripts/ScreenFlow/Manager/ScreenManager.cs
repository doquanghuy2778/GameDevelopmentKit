namespace GameFoundationCore.ScreenFlow.Manager
{
    ...
    public class ScreenManager : IScreenManager, IInitializable, IDisposable, ITickable
    {
        #region Constructor
        ...
        public async UniTask<T> OpenScreen<T>() where T : IScreenPresenter
        {
            ...
            if (nextScreen != null)
            {
                ...
                this.activeScreens.Add(nextScreen);
        ...
        {
            if (this.typeToLoadedScreenPresenter.TryGetValue(screenType, out var screenPresenter))
            {
